...
public partial class testpage3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            try
            {
                ...
                sqlcon.Open();
                sqlcmd.CommandText = "select * from Question_Table where Question_Id=4";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sqlcmd.CommandText = "select Correct_Answer from Question_Table where Question_Id=4";
        ...
        Response.Redirect("testpage4.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("testpage2.aspx");
    }
